...
class GamesController {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query(`DELETE FROM game where id='${id}'`, function (err, result, fields) {
                if (err)
                    throw err;
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE game set ? WHERE id= ?', [req.body, id], function (err, result, fields) {
                if (err)
                    throw err;
